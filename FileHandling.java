...
public static void main(String[] args) throws IOException {
		...
		Scanner sc =new Scanner(System.in);
		 ...
		 try {
		        ...
		        FileReader input = new FileReader("E:\\File handle\\file.txt");
	   ...
	   try {
	      ...
	      FileWriter output = new FileWriter("E:\\File handle\\file.txt");
	    ...
	    File file = new File("E:\\File handle\\file.txt");
